...
<div class="wrap">
    <div class="container">
        <h1>Welcome</h1>
        <form action="index1.php" method="post">  <!--action是表格数据传到哪个页面-->
    ...
    if($row[passwd]==$passwd){
        ...
        $_SESSION['id'] = $id;
        //echo "<script>location.href='user.php';</script>";   //跳转到librarian用户中心页面
        header("Location:user.php");	//跳转到librarian用户中心页面
